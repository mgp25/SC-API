...
class Snapchat extends SnapchatAgent {
	...
	public function getFriends()
	{
		...
		{
				$friendList[$friend->name] = empty($friend->display) ? $friend->name : utf8_encode($friend->display);
		}
	...
	public function getAddedFriends()
	{
		...
		foreach($friends as $friend)
		{
				$friendList[$friend->name] = empty($friend->display) ? $friend->name : utf8_encore($friend->display);
		}
